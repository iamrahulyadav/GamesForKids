...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function () {
	    ...
	    _createClass(App, [{
	        ...
	        key: 'createOrMoveCircle',
	        value: function createOrMoveCircle(svg) {
	            var _this = this;

	            var old_data = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
	            ...
	            while (old_data !== null && this.isNear(old_data, data)) {
	            ...
	            circle.enter().append('circle').attr({
	                ...
	                _this.createOrMoveCircle(svg, d);
	            });
	        ...
	        key: 'isNear',
	        value: function isNear(a, b) {
	            var distance = Math.sqrt(Math.pow(Math.abs(a.cx - b.cx), 2) + Math.pow(Math.abs(a.cy - b.cy), 2));
